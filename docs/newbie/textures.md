...
3. 材质信息设置完成后，点击<BSButton style="background-color: #28a745;">确认上传</BSButton>按钮。
    ...
    > [!CAUTION] 🚫 禁止上传的材质
    > HelloSkin <mark>不允许上传包括但不限于如下内容的敏感材质</mark>：
    >
    > - **高清的色情敏感** 的材质
    > - **政治敏感** 的材质，包括但不限于：
    >
    ...
    > - 违反中国大陆地区相关法律的材质
    >
    > 对于不适宜出现在公众面前的材质，你需要在上传时将其 **设为私密材质**，否则一经发现，相关材质将被删除，且你将被 HelloSkin **永久封禁**。

    > [!TIP] 提示
    > 私密材质需要消耗更多的积分，可在 [H币系统](../score) 章节中了解到更多有关积分的信息。
...
你可以将衣柜中的皮肤的面部设置为你在 HelloSkin 的头像。
